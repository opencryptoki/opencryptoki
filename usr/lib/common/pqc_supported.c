...
const struct pqc_oid dilithium_oids[] = {
    { .oid = dilithium_r2_65, .oid_len = sizeof(dilithium_r2_65),
      ...
      .len_info.ml_dsa.rho_len = 32, .len_info.ml_dsa.seed_len = 32,
      .len_info.ml_dsa.tr_len = 48, .len_info.ml_dsa.s1_len = 480,
      .len_info.ml_dsa.s2_len = 576, .len_info.ml_dsa.t0_len = 2688,
      .len_info.ml_dsa.t1_len = 1728, },
    { .oid = dilithium_r2_87, .oid_len = sizeof(dilithium_r2_87),
      ...
      .len_info.ml_dsa.rho_len = 32, .len_info.ml_dsa.seed_len = 32,
      .len_info.ml_dsa.tr_len = 48, .len_info.ml_dsa.s1_len = 672,
      .len_info.ml_dsa.s2_len = 768, .len_info.ml_dsa.t0_len = 3584,
      .len_info.ml_dsa.t1_len = 2304, },
    { .oid = dilithium_r3_44, .oid_len = sizeof(dilithium_r3_44),
      ...
      .len_info.ml_dsa.rho_len = 32, .len_info.ml_dsa.seed_len = 32,
      .len_info.ml_dsa.tr_len = 32, .len_info.ml_dsa.s1_len = 384,
      .len_info.ml_dsa.s2_len = 384, .len_info.ml_dsa.t0_len = 1664,
      .len_info.ml_dsa.t1_len = 1280, },
    { .oid = dilithium_r3_65, .oid_len = sizeof(dilithium_r3_65),
      ...
      .len_info.ml_dsa.rho_len = 32, .len_info.ml_dsa.seed_len = 32,
      .len_info.ml_dsa.tr_len = 32, .len_info.ml_dsa.s1_len = 640,
      .len_info.ml_dsa.s2_len = 768, .len_info.ml_dsa.t0_len = 2496,
      .len_info.ml_dsa.t1_len = 1920, },
    { .oid = dilithium_r3_87, .oid_len = sizeof(dilithium_r3_87),
      ...
      .len_info.ml_dsa.rho_len = 32, .len_info.ml_dsa.seed_len = 32,
      .len_info.ml_dsa.tr_len = 32, .len_info.ml_dsa.s1_len = 672,
      .len_info.ml_dsa.s2_len = 768, .len_info.ml_dsa.t0_len = 3328,
      .len_info.ml_dsa.t1_len = 2560, },
...
const struct pqc_oid kyber_oids[] = {
    { .oid = kyber_r2_768, .oid_len = sizeof(kyber_r2_768),
       ...
       .len_info.ml_kem.fs_len = 64, .len_info.ml_kem.pubseed_len = 32,
       .len_info.ml_kem.ct_len = 1088 },
    { .oid = kyber_r2_1024, .oid_len = sizeof(kyber_r2_1024),
      .keyform = CK_IBM_KYBER_KEYFORM_ROUND2_1024,
      .policy_size = 256, .policy_siglen = 0,
      .len_info.ml_kem.sk_len = 3168, .len_info.ml_kem.pk_len = 1568,
      .len_info.ml_kem.fs_len = 64, .len_info.ml_kem.pubseed_len = 32,
      .len_info.ml_kem.ct_len = 1568},
    { .oid = NULL, .oid_len = 0, .keyform = 0,
      .policy_size = 0, .policy_siglen = 0 }
};

const CK_BYTE ml_dsa_44[] = OCK_ML_DSA_44;
const CK_BYTE ml_dsa_65[] = OCK_ML_DSA_65;
const CK_BYTE ml_dsa_87[] = OCK_ML_DSA_87;

const struct pqc_oid ml_dsa_oids[] = {
    { .oid = ml_dsa_44, .oid_len = sizeof(ml_dsa_44),
      .keyform = CKP_ML_DSA_44,
      .policy_size = 128, .policy_siglen = 128,
      .len_info.ml_dsa.rho_len = 32, .len_info.ml_dsa.seed_len = 32,
      .len_info.ml_dsa.tr_len = 64, .len_info.ml_dsa.s1_len = 384,
      .len_info.ml_dsa.s2_len = 384, .len_info.ml_dsa.t0_len = 1664,
      .len_info.ml_dsa.t1_len = 1280, .len_info.ml_dsa.priv_seed_len = 32, },
    { .oid = ml_dsa_65, .oid_len = sizeof(ml_dsa_65),
      .keyform = CKP_ML_DSA_65,
      .policy_size = 192, .policy_siglen = 192,
      .len_info.ml_dsa.rho_len = 32, .len_info.ml_dsa.seed_len = 32,
      .len_info.ml_dsa.tr_len = 64, .len_info.ml_dsa.s1_len = 640,
      .len_info.ml_dsa.s2_len = 768, .len_info.ml_dsa.t0_len = 2496,
      .len_info.ml_dsa.t1_len = 1920, .len_info.ml_dsa.priv_seed_len = 32, },
    { .oid = ml_dsa_87, .oid_len = sizeof(ml_dsa_87),
      .keyform = CKP_ML_DSA_87,
      .policy_size = 256, .policy_siglen = 256,
      .len_info.ml_dsa.rho_len = 32, .len_info.ml_dsa.seed_len = 32,
      .len_info.ml_dsa.tr_len = 64, .len_info.ml_dsa.s1_len = 672,
      .len_info.ml_dsa.s2_len = 768, .len_info.ml_dsa.t0_len = 3328,
      .len_info.ml_dsa.t1_len = 2560, .len_info.ml_dsa.priv_seed_len = 32, },
    { .oid = NULL, .oid_len = 0, .keyform = 0,
      .policy_size = 0, .policy_siglen = 0 }
};
...
const struct pqc_oid ml_kem_oids[] = {
    { .oid = ml_kem_512, .oid_len = sizeof(ml_kem_512),
      .keyform = CKP_ML_KEM_512,
      .policy_size = 126, .policy_siglen = 0,
      .len_info.ml_kem.sk_len = 1632, .len_info.ml_kem.pk_len = 800,
      .len_info.ml_kem.fs_len = 64, .len_info.ml_kem.priv_seed_len = 64,
      .len_info.ml_kem.pubseed_len = 32, .len_info.ml_kem.ct_len = 768 },
    { .oid = ml_kem_768, .oid_len = sizeof(ml_kem_768),
      .keyform = CKP_ML_KEM_768,
      .policy_size = 192, .policy_siglen = 0,
      .len_info.ml_kem.sk_len = 2400, .len_info.ml_kem.pk_len = 1184,
      .len_info.ml_kem.fs_len = 64, .len_info.ml_kem.priv_seed_len = 64,
      .len_info.ml_kem.pubseed_len = 32, .len_info.ml_kem.ct_len = 1088 },
    { .oid = ml_kem_1024, .oid_len = sizeof(ml_kem_1024),
      .keyform = CKP_ML_KEM_1024,
      .policy_size = 256, .policy_siglen = 0,
      .len_info.ml_kem.sk_len = 3168, .len_info.ml_kem.pk_len = 1568,
      .len_info.ml_kem.fs_len = 64, .len_info.ml_kem.priv_seed_len = 64,
      .len_info.ml_kem.pubseed_len = 32, .len_info.ml_kem.ct_len = 1568 },
    { .oid = NULL, .oid_len = 0, .keyform = 0,
      .policy_size = 0, .policy_siglen = 0 }
};
