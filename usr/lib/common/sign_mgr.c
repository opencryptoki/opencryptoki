                    ...
                    CK_BYTE *out_data, CK_ULONG *out_data_len)
{
    ...
    case CKM_ML_DSA:
        return ml_dsa_sign(tokdata, sess, length_only, ctx,
                           in_data, in_data_len, out_data, out_data_len, TRUE);
    case CKM_HASH_ML_DSA:
    case CKM_HASH_ML_DSA_SHA224:
    case CKM_HASH_ML_DSA_SHA256:
    case CKM_HASH_ML_DSA_SHA384:
                           ...
                           CK_BYTE *in_data, CK_ULONG in_data_len)
{
    ...
    case CKM_ML_DSA:
        return ml_dsa_sign(tokdata, sess, FALSE, ctx,
                           in_data, in_data_len, NULL, NULL, FALSE);
    case CKM_HASH_ML_DSA_SHA224:
    case CKM_HASH_ML_DSA_SHA256:
    case CKM_HASH_ML_DSA_SHA384:
    case CKM_HASH_ML_DSA_SHA512:
