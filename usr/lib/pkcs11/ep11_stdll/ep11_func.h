...
typedef unsigned int (*m_DigestKey_t) (unsigned char *state, size_t slen,
                                       ...
                                       uint64_t target);
typedef unsigned int (*m_DigestFinal_t) (const unsigned char *state,
...
typedef unsigned int (*m_DecryptFinal_t) (const unsigned char *state,
                                          size_t slen, CK_BYTE_PTR output,
                                          CK_ULONG_PTR len, uint64_t target);
typedef unsigned int (*m_EncryptSingle_t) (const unsigned char *key,
                                           size_t klen, CK_MECHANISM_PTR mech,
                                           CK_BYTE_PTR plain, CK_ULONG plen,
                                           CK_BYTE_PTR cipher,
                                           CK_ULONG_PTR clen, uint64_t target);
typedef unsigned int (*m_DecryptSingle_t) (const unsigned char *key,
                                           size_t klen, CK_MECHANISM_PTR mech,
                                           CK_BYTE_PTR cipher, CK_ULONG clen,
                                           CK_BYTE_PTR plain, CK_ULONG_PTR plen,
                                           uint64_t target);
...
typedef unsigned int (*m_SignFinal_t) (const unsigned char *state, size_t stlen,
                                       ...
                                       uint64_t target);
typedef unsigned int (*m_VerifyFinal_t) (const unsigned char *state,
