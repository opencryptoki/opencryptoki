...
typedef struct {
    unsigned int version;               /* EVENT_VERSION_xxx */
    unsigned long positive_replies;     /* Number of tokens that replied a */
    unsigned long negative_replies;     /* positive, or negative feedback, */
    unsigned long nothandled_replies;   /* or that did not handle the event. */
