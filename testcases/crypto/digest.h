...
#define NUM_DIGEST_TEST_SUITES 19
struct digest_test_suite_info digest_test_suites[] = {
    {
        ...
        .tvcount = 6,
        .tv = sha3_224_digest_test_vector,
        .mech = {CKM_SHA3_224, 0, 0},
    }, {
        .name = "SHA3-256",
        .tvcount = 6,
        .tv = sha3_256_digest_test_vector,
        .mech = {CKM_SHA3_256, 0, 0},
    }, {
        .name = "SHA3-384",
        .tvcount = 6,
        .tv = sha3_384_digest_test_vector,
        .mech = {CKM_SHA3_384, 0, 0},
    }, {
        .name = "SHA3-512",
        .tvcount = 6,
        .tv = sha3_512_digest_test_vector,
        .mech = {CKM_SHA3_512, 0, 0},
    },
};
...
/*  Test vectors for HMAC SHA3-224:
 */
struct HMAC_TEST_VECTOR sha3_224_hmac_general_test_vector[] = {
    {
        .key = {0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,
                0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,
                0x0b,0x0b},
...
/*  Test vectors for HMAC SHA3-256:
 */
struct HMAC_TEST_VECTOR sha3_256_hmac_general_test_vector[] = {
    {
        .key = {0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,
                0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,
                0x0b,0x0b},
...
/*  Test vectors for HMAC SHA3-384:
 */
struct HMAC_TEST_VECTOR sha3_384_hmac_general_test_vector[] = {
    {
        .key = {0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,
                0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,
                0x0b,0x0b},
...
/*  Test vectors for HMAC SHA3-512:
 */
struct HMAC_TEST_VECTOR sha3_512_hmac_general_test_vector[] = {
    {
        .key = {0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,
                0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,
                0x0b,0x0b},
...
#define NUM_OF_HMAC_TEST_SUITES 28
struct HMAC_TEST_SUITE_INFO hmac_test_suites[] = {
    ...
    },
    {
        ...
        .tvcount = 6,
        .tv = sha3_224_hmac_test_vector,
        .mech = { CKM_SHA3_224_HMAC, 0, 0 },
    },
    {
        .name = "SHA3-256 HMAC",
        .tvcount = 6,
        .tv = sha3_256_hmac_test_vector,
        .mech = { CKM_SHA3_256_HMAC, 0, 0 },
    },
    {
        .name = "SHA3-384 HMAC",
        .tvcount = 6,
        .tv = sha3_384_hmac_test_vector,
        .mech = { CKM_SHA3_384_HMAC, 0, 0 },
    },
    {
        .name = "SHA3-512 HMAC",
        .tvcount = 6,
        .tv = sha3_512_hmac_test_vector,
        .mech = { CKM_SHA3_512_HMAC, 0, 0 },
    },
    {
        .name = "SHA3-224 HMAC General",
        .tvcount = 6,
        .tv = sha3_224_hmac_general_test_vector,
        .mech = { CKM_SHA3_224_HMAC_GENERAL, &ten, sizeof(CK_ULONG) },
    },
    {
        .name = "SHA3-256 HMAC General",
        .tvcount = 6,
        .tv = sha3_256_hmac_general_test_vector,
        .mech = { CKM_SHA3_256_HMAC_GENERAL, &ten, sizeof(CK_ULONG) },
    },
    {
        .name = "SHA3-384 HMAC General",
        .tvcount = 6,
        .tv = sha3_384_hmac_general_test_vector,
        .mech = { CKM_SHA3_384_HMAC_GENERAL, &ten, sizeof(CK_ULONG) },
    },
    {
        .name = "SHA3-512 HMAC General",
        .tvcount = 6,
        .tv = sha3_512_hmac_general_test_vector,
        .mech = { CKM_SHA3_512_HMAC_GENERAL, &ten, sizeof(CK_ULONG) },
    },
};
