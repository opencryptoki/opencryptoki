...
static struct des3_test_vector des3_cfb8_tv[] = {
    {                           //count 0
        ...
        .ivlen = DES3_IV_SIZE,
        .plaintext = {0x0a, 0xde, 0x78, 0x94, 0xf8, 0x58, 0x7f, 0x64, 0x1a},
        .plen = 9,
        .ciphertext = {0xcb, 0x13, 0x47, 0xba, 0x2a, 0xb6, 0x13, 0x8b, 0xfc},
        .clen = 9,
        .num_chunks = 3,
        .chunks = {4, -1, 5},
    }, {       //count 9
        ...
        .ivlen = DES3_IV_SIZE,
        .plaintext = {0x45, 0x0c, 0xa7, 0xf4, 0xe0, 0x10, 0x57,
                      0xec, 0x20, 0x1f},
        .plen = 10,
        .ciphertext = {0x4c, 0xd4, 0x18, 0x46, 0xcf, 0x2f, 0xf0,
                       0x94, 0x6b, 0x88},
        .clen = 10,
        .num_chunks = 3,
        .chunks = {5, 0, 5},
