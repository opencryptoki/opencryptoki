...
struct HMAC_TEST_VECTOR sha256_hmac_test_vector[] = {
        {
	        ...
	        .key =        { 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
                ...
                .data_len = 54,
                .hash_len = 32,
                .result =     { 0x60, 0xe4, 0x31, 0x59, 0x1e, 0xe0, 0xb6, 0x7f,
	        ...
	        .key =        { 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
                ...
                .hash_len = 32,
                .result =     { 0x9b, 0x09, 0xff, 0xa7, 0x1b, 0x94, 0x2f, 0xcb,
...
struct HMAC_TEST_VECTOR sha512_hmac_test_vector[] = {
        {
	        ...
	        .key =        { 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
                ...
                .data_len = 54,
                .hash_len = 64,
                .result =     { 0x80, 0xb2, 0x42, 0x63, 0xc7, 0xc1, 0xa3, 0xeb,
	        ...
	        .key =        { 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
                ...
                .data_len = 148,
                .hash_len = 64,
                .result =     { 0xe3, 0x7b, 0x6a, 0x77, 0x5d, 0xc8, 0x7d, 0xba,
