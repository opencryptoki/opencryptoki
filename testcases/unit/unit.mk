...
testcases_unit_policytest_SOURCES=testcases/unit/policytest.c		\
	...
	usr/lib/config/configuration.c usr/lib/api/mechtable.c		\
	usr/lib/common/ec_curve_translation.c				\
	usr/lib/common/kdf_translation.c				\
	usr/lib/common/mgf_translation.c usr/lib/config/cfglex.c	\
	usr/lib/config/cfgparse.c usr/lib/api/supportedstrengths.c
