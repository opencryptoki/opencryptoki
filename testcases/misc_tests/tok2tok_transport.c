...
struct wrapping_mech_info wrapping_tests[] = {
    ...
    {
        .name = "Wrap/Unwrap with ECDH-COF AES KEY WRAP (AES 256, P-256)",
        .wrapping_mech = { CKM_ECDH_COF_AES_KEY_WRAP,
                           &ecdh_aeskw_aes_256__params,
                           sizeof(CK_ECDH_AES_KEY_WRAP_PARAMS) },
        .wrapping_key_gen_mech = { CKM_EC_KEY_PAIR_GEN, 0, 0 },
        .ec_parms = prime256v1,
    ...
    {
        .name = "Wrap/Unwrap with ECDH-X AES KEY WRAP (AES 256, X25519)",
        .wrapping_mech = { CKM_ECDH_X_AES_KEY_WRAP,
                           &ecdh_aeskw_aes_256__params,
                           sizeof(CK_ECDH_AES_KEY_WRAP_PARAMS) },
        .wrapping_key_gen_mech = { CKM_EC_MONTGOMERY_KEY_PAIR_GEN, 0, 0 },
        .ec_parms = curve25519,
